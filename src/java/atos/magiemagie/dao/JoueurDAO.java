...
//import static atos.magiemagie.Carte_.joueur;
...
public class JoueurDAO {
    ...
    public  List<Joueur> listerAutresJoueurDePartie(long monId, long partieId) {
        EntityManager em = Persistence.createEntityManagerFactory("PU").createEntityManager();
        Query query = em.createQuery("SELECT j FROM Joueur j join j.partie p where p.id=:partieId EXCEPT SELECT j FROM Joueur j JOIN j.partie p WHERE j.id=:monId");
